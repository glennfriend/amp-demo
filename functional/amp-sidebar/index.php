  ...
  <body>
    ...
    <amp-sidebar id="header-sidebar" class="ampstart-sidebar px3  " layout="nodisplay">
      ...
      <nav class="ampstart-sidebar-nav ampstart-nav">
        <ul class="list-reset m0 p0 ampstart-label">
                ...
                <amp-accordion layout="container" disable-session-states="" class="ampstart-dropdown">
                  <section>
                    ...
                    <ul class="ampstart-dropdown-items list-reset m0 p0">
                        <li class="ampstart-dropdown-item"><a href="#" class="text-decoration-none">A-1-1</a></li>
                        <li class="ampstart-dropdown-item"><a href="#" class="text-decoration-none">A-1-2</a></li>
                    </ul>
                  </section>
                </amp-accordion>
                <!-- End Dropdown-inline -->
              ...
              <li class="ampstart-nav-item "><a class="ampstart-nav-link" href="#">B-1</a></li>
              <li class="ampstart-nav-item ampstart-nav-dropdown relative ">
                ...
                <amp-accordion layout="container" disable-session-states="" class="ampstart-dropdown">
                  <section>
                    <header>C-1</header>
                    <ul class="ampstart-dropdown-items list-reset m0 p0">
                        <li class="ampstart-dropdown-item"><a href="#" class="text-decoration-none">C-1-1</a></li>
                        <li class="ampstart-dropdown-item"><a href="#" class="text-decoration-none">C-1-2</a></li>
                    </ul>
                  </section>
                </amp-accordion>
                <!-- End Dropdown-inline -->
              ...
              <li class="ampstart-nav-item "><a class="ampstart-nav-link" href="#">D-1</a></li>
              <li class="ampstart-nav-item "><a class="ampstart-nav-link" href="#">E-1</a></li>
        </ul>
      </nav>
    ...
    <main id="content" role="main" class="">
      <article class="recipe-article">
        ...
        <p class="mb4 px3">Sed consequat, leo eget bibendum sodales, augue velit cursus nunc, quis gravida magna mi a libero.</p>
        <p class="mb4 px3">Duis arcu tortor, suscipit eget, imperdiet nec, imperdiet iaculis, ipsum.</p>
